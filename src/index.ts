...
/** Read-only status snapshot for CLI / scripting (Vite panel uses the same helper). */
export { resolveDevStatus } from "./core/status.ts";
export type { ResolveDevStatusOptions, DevStatus } from "./core/status.ts";
