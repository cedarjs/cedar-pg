 ...
 * CLI shortcuts (`d` status, `s` studio). Does **not** acquire — pair with
 * `cedarPgTasks()` / `dependsOn: ['db:acquire']`. Shortcuts need Vite 8+ to
 * merge; `s` does not collide with `--profile`.
 */
